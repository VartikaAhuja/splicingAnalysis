...
# Read transcript count matrix and sample metadata
...
# Create DESeq2 dataset and filter low-count transcripts
...
# Filter transcripts with p-value < 0.05 and logFC ≥ 1
...
dim(new_data)
# Count prevalence of isoforms across tumor vs normal samples
...
# Apply thresholds (e.g., ≥80% tumor, ≤20% normal) to identify tumor-specific isoforms
...
# Merge transcript IDs with gene IDs and save results
